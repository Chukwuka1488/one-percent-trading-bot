...
1. Make sure you have a Linear API key (you'll need it for actual operations,
   but not for help/completion):
...
3. Alternatively, you can add the directory to your PATH or create a symlink
   manually.
...
`linear get-issue ENG-XXXX > ai/docs/shared/tickets/eng-XXXX.md`
```
